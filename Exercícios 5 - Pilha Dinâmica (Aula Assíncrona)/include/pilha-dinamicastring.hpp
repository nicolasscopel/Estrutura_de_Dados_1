#ifndef _HPP_PILHA_DINAMICASTRING
#define _HPP_PILHA_DINAMICASTRING
...
//push
bool empilhaP(Pilha *p, string dado)
{
...
bool buscaP(Pilha *p, string dado)
{
...
#endif // _HPP_PILHA_DINAMICASTRING
